...
import {
  ConfigOptions,
  ForceGraph3DInstance as ForceGraphKapsuleInstance,
} from "3d-force-graph";
...
type LinkAccessor<NodeType, LinkType, T> = Accessor<
...
export interface ForceGraphProps<NodeType = {}, LinkType = {}>
  ...
  onNodeHover?: (
    node: NodeObject<NodeType> | null,
    previousNode: NodeObject<NodeType> | null
  ) => void;
  onNodeDrag?: (
...
export interface ForceGraphMethods<NodeType = {}, LinkType = {}> {
  // Link styling
...
type FCwithRef = <NodeType = {}, LinkType = {}>(
